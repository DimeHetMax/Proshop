...
import { useGetProductDetailsQuery, useCreateProductReviewsMutation } from "../slices/productsApiSlice.js";
...
const ProductScreen = () => {
    ...
    const [createReview, { isLoading: LoadingProductReview, }] = useCreateProductReviewsMutation()
    ...
    const submitHandler = async (e) => {
        e.preventDefault();
        console.log("submit Handler in reviews!!",
            rating, comment
        );
        try {
